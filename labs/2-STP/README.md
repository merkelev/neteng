...
**На коммутаторе SW2 в качестве корневого порта выбран Gi0/1, так как стоимость порта Gi0/0 составляет 18**  
**На коммутаторе SW3 в качестве корневого порта выбран Gi0/2, так как стоимость через порты Gi0/0, Gi0/1 выше чем через Gi0/2. Порт Gi0/3 не выбран в качестве корневого потому что ID порта Gi0/2 меньше Gi0/3.**  
